...
int main()
{
    ...
    printf("%d", number);/*Since it should not be added so we are adding this divisor seperaely*/

    printf("\nSum of Divisor(excluding itself): %d\n\n", sum_of_divisor_of_number);/*Printing the sum of divisor*/
