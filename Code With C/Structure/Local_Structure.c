/*
WAP to store record of a student that contains name, roll, section and marks using structure(Local)
*/
...
int main()
{
    /*This will declared localstructure. And accessible only in main function not in other function*/
